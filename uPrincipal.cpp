...
void __fastcall TfrmPrincipal::btnPrimeiroQuadranteClick(TObject *Sender)
{
	mundo.xMax = 0;
	mundo.xMin = -250;
	mundo.yMax = 250;
...
void __fastcall TfrmPrincipal::btnSegundoQuadranteClick(TObject *Sender)
{
	mundo.xMax = 250;
	mundo.xMin = 0;
	mundo.yMax = 250;
...
void __fastcall TfrmPrincipal::btnTerceiroQuadranteClick(TObject *Sender)
{
	mundo.xMax = 0;
	mundo.xMin = -250;
	mundo.yMax = 0;
...
void __fastcall TfrmPrincipal::btnQuartoQuadranteClick(TObject *Sender)
{
	mundo.xMax = 250;
	mundo.xMin = 0;
	mundo.yMax = 0;
